      ...
      (e.startTransition = function (e) {
        ...
        try {
          var r = e(),
            i = C.S;
          (i !== null && i(n, r),
            typeof r == `object` && r && typeof r.then == `function` && r.then(S, D));
        } catch (e) {
          D(e);
        } finally {
      ...
      (e.unstable_scheduleCallback = function (r, i, a) {
        ...
        return (
          ...
          a > o
            ? ((r.sortIndex = a),
              t(l, r),
              n(c) === null && r === n(l) && (h ? (v(S), (S = -1)) : (h = !0), ie(x, a - o)))
            : ((r.sortIndex = s), t(c, r), m || p || ((m = !0), ee || ((ee = !0), E()))),
          r
        );
      }),
...
` +
    ...
    function yi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) gi(e) && (s = 1);
        ...
        a: switch (e) {
          ...
          case w:
            return ((e = hi(13, n, t, a)), (e.elementType = w), (e.lanes = o), e);
          case T:
    ...
    function Ti(e, t) {
      if (typeof e == `object` && e) {
        var n = wi.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: De(t) }), wi.set(e, t), t) : n;
      }
...
function ce(e, t, n, r, i) {
  let a = Ce((typeof t == `string` ? ie(t) : t).pathname || `/`, n);
...
function le(e, t = [], n = [], r = ``, i = !1) {
  ...
  return (
    e.forEach((e, t) => {
      ...
      else for (let n of ue(e.path)) a(e, t, !0, n);
    }),
    t
  );
}
...
function _e(e, t) {
  ...
  return (
    n.some(ge) && (r += he),
    t && (r += A),
    n.filter((e) => !ge(e)).reduce((e, t) => e + (fe.test(t) ? k : t === `` ? pe : me), r)
  );
}
function ve(e, t) {
...
var we = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i;
function Te(e, t = `/`) {
  let { pathname: n, search: r = ``, hash: i = `` } = typeof e == `string` ? ie(e) : e,
    a;
  return (
    n ? ((n = je(n)), (a = n.startsWith(`/`) ? Ee(n.substring(1), `/`) : Ee(n, t))) : (a = t),
...
function Ae(e, t, n, r = !1) {
  ...
  typeof e == `string`
    ? (i = ie(e))
    : ((i = { ...e }),
      w(!i.pathname || !i.pathname.includes(`?`), De(`?`, `pathname`, `search`, i)),
      w(!i.pathname || !i.pathname.includes(`#`), De(`#`, `pathname`, `hash`, i)),
...
function Ve(e, t) {
  let n = e;
  if (typeof n != `string` || !we.test(n)) return { absoluteURL: void 0, isExternal: !1, to: n };
  let r = n,
    i = !1;
  if (Be)
    try {
...
function ot(e, { relative: t } = {}) {
  ...
  let { basename: n, navigator: r } = x.useContext(Ze),
    ...
    s = a;
  return (
    n !== `/` && (s = a === `/` ? n : Me([n, a])), r.createHref({ pathname: s, search: o, hash: i })
  );
}
function st() {
...
function ct() {
  return (
    w(st(), `useLocation() may be used only in the context of a <Router> component.`),
...
function ft() {
  w(st(), `useNavigate() may be used only in the context of a <Router> component.`);
  ...
  return (
    ...
    x.useCallback(
      (r, s = {}) => {
        ...
        let c = Ae(r, JSON.parse(a), i, s.relative === `path`);
...
function ht(e, t, n) {
  w(st(), `useRoutes() may be used only in the context of a <Router> component.`);
...
Please change the parent <Route path="${e}"> to <Route path="${e === `/` ? `*` : `${e}/*`}">.`,
  ...
  let m =
    n && n.state.matches.length
      ? n.state.matches.map((e) => Object.assign(e, { route: n.manifest[e.route.id] || e.route }))
      : se(e, { pathname: p });
  (T(l || m != null, `No routes matched location "${d.pathname}${d.search}${d.hash}" `),
    T(
      m == null ||
      ...
      let t =
        e === void 0
          ...
          : x.createElement(
              ...
              x.createElement(et.Provider, { value: e, children: this.props.component }),
            );
...
function kt() {
  let { matches: e, loaderData: t } = Tt(`useMatches`);
  return x.useMemo(() => e.map((e) => D(e, t)), [e, t]);
}
function At() {
...
x.memo(Pt);
function Pt({ routes: e, manifest: t, future: n, state: r, isStatic: i, onError: a }) {
  return ht(e, void 0, { manifest: t, state: r, isStatic: i, onError: a, future: n });
}
function Ft(e) {
  w(
    !1,
  ...
  return (
    x.Children.forEach(e, (e, r) => {
      ...
      (w(
        ...
        w(!e.props.index || !e.props.children, `An index route cannot have child routes.`));
      let a = {
...
var Yt = new Set([`application/x-www-form-urlencoded`, `multipart/form-data`, `text/plain`]);
function Xt(e) {
...
function Zt(e, t) {
  ...
  if (Ut(e)) {
    ...
    if (
      ...
      (i = Xt(e.getAttribute(`formenctype`)) || Xt(o.getAttribute(`enctype`)) || Bt),
      (a = new FormData(o, e)),
      !Jt())
    ) {
...
function pn() {
  let e = x.useContext(We);
  return (tn(e, `You must render this element inside a <DataRouterContext.Provider> element`), e);
}
function mn() {
  let e = x.useContext(Ge);
  return (
    tn(e, `You must render this element inside a <DataRouterStateContext.Provider> element`), e
  );
}
var hn = x.createContext(void 0);
hn.displayName = `FrameworkContext`;
function gn() {
  let e = x.useContext(hn);
  return (tn(e, `You must render this element inside a <HydratedRouter> element`), e);
}
function _n(e, t) {
  let n = x.useContext(hn),
    [r, i] = x.useState(!1),
    [a, o] = x.useState(!1),
...
function yn({ page: e, ...t }) {
  let n = qe(),
    { router: r } = pn(),
    i = x.useMemo(() => se(r.routes, e, r.basename), [r.routes, e, r.basename]);
  return i
    ? n
...
function bn(e) {
  let { manifest: t, routeModules: n } = gn(),
    [r, i] = x.useState([]);
  return (
    x.useEffect(() => {
      let r = !1;
...
function xn({ page: e, matches: t, ...n }) {
  ...
  return x.createElement(
    x.Fragment,
    null,
    o.map((e) => x.createElement(`link`, { key: e, rel: `prefetch`, as: `fetch`, href: e, ...n })),
  );
}
function Sn({ page: e, matches: t, ...n }) {
  let r = ct(),
    ...
    f = x.useMemo(() => {
      ...
      if (
        ...
        return [];
      let d = nn(e, s, i.unstable_trailingSlashAwareDataRequests, `data`);
      return (
        l &&
          n.size > 0 &&
          d.searchParams.set(
  ...
  return x.createElement(
    x.Fragment,
    null,
    f.map((e) => x.createElement(`link`, { key: e, rel: `prefetch`, as: `fetch`, href: e, ...n })),
    p.map((e) => x.createElement(`link`, { key: e, rel: `modulepreload`, href: e, ...n })),
    m.map(({ key: e, link: t }) =>
...
var wn =
  typeof window < `u` && window.document !== void 0 && window.document.createElement !== void 0;
try {
  wn && (window.__reactRouterVersion = `7.15.1`);
} catch {}
...
var Dn = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  On = x.forwardRef(function (
    ...
    let b = ot(l, { relative: r }),
      ...
      S = null;
    if (o) {
      let e = Ae(o, [], ee.mask ? ee.mask.pathname : `/`, !0);
      (h !== `/` && (e.pathname = e.pathname === `/` ? h : Me([h, e.pathname])),
        (S = g.createHref(e)));
    }
    let [C, w, T] = _n(n, p),
      te = Fn(l, {
    ...
    return C && !v ? x.createElement(x.Fragment, null, re, x.createElement(yn, { page: b })) : re;
  });
On.displayName = `Link`;
var kn = x.forwardRef(function (
  ...
  let y = g !== `/` && g.endsWith(`/`) ? g.length - 1 : g.length,
    ...
    ee = v != null && (v === g || (!r && v.startsWith(g) && v.charAt(g.length) === `/`)),
  ...
  w =
    typeof n == `function`
      ? n(S)
      : [n, b ? `active` : null, ee ? `pending` : null, h ? `transitioning` : null]
          .filter(Boolean)
          .join(` `);
  let T = typeof i == `function` ? i(S) : i;
  return x.createElement(
    On,
    { ...c, "aria-current": C, className: w, ref: l, style: T, to: a, viewTransition: o },
...
function Un({ getKey: e, storageKey: t } = {}) {
  let { router: n } = Nn(`useScrollRestoration`),
    { restoreScrollPosition: r, preventScrollReset: i } = Pn(`useScrollRestoration`),
...
var Kn = o((e) => {
  ...
  Yn = qn();
function Xn() {
  return (0, Yn.jsx)(`main`, { children: (0, Yn.jsx)(`h1`, { children: `Genesis Elias-Wilson` }) });
}
function Zn() {
  return (0, Yn.jsx)(Tn, {
    children: (0, Yn.jsx)(Lt, {
      children: (0, Yn.jsx)(Ft, { path: `/`, element: (0, Yn.jsx)(Xn, {}) }),
    }),
  });
}
Jn.createRoot(document.getElementById(`root`)).render(
  (0, Yn.jsx)(x.StrictMode, { children: (0, Yn.jsx)(Zn, {}) }),
);
